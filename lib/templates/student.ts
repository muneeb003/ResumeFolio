            ...
            <div class="stu-card" style="background:#fff;border-radius:20px;overflow:hidden;box-shadow:0 2px 12px rgba(0,0,0,.06);border:1px solid #f1f5f9;transition:transform .2s,box-shadow .2s">
              ...
              <div style="padding:20px">
                ...
                <div style="display:flex;gap:8px;flex-wrap:wrap">
                  ${p.liveUrl ? `<a href="${safeUrl(p.liveUrl)}" target="_blank" rel="noopener" style="font-size:12px;font-weight:700;color:#fff;background:${a};text-decoration:none;padding:7px 15px;border-radius:10px">Live ↗</a>` : ''}
                  ${p.repoUrl ? `<a href="${safeUrl(p.repoUrl)}" target="_blank" rel="noopener" style="font-size:12px;font-weight:700;color:#475569;background:#f8fafc;text-decoration:none;padding:7px 15px;border-radius:10px;border:1px solid #e2e8f0">Repo ↗</a>` : ''}
                </div>
              </div>
            </div>`
            )
      ...
      `<section id="stu-contact" class="stu-section" style="opacity:0;transform:translateY(24px);transition:opacity .5s ease,transform .5s ease;margin-bottom:52px">
        ...
        <div style="background:#fff;border-radius:20px;padding:32px;box-shadow:0 2px 12px rgba(0,0,0,.06);border:1px solid #f1f5f9;text-align:center">
          ...
          <div style="display:flex;justify-content:center;flex-wrap:wrap;gap:14px">
            ...
            ${
              d.contact.github
                ? `<a href="${safeUrl(d.contact.github)}" target="_blank" rel="noopener" style="display:inline-flex;align-items:center;gap:10px;font-size:14px;font-weight:700;color:#0f172a;background:#f1f5f9;text-decoration:none;padding:13px 24px;border-radius:14px;transition:opacity .2s;border:1px solid #e2e8f0">
            ...
            ${
              d.contact.linkedin
                ? `<a href="${safeUrl(d.contact.linkedin)}" target="_blank" rel="noopener" style="display:inline-flex;align-items:center;gap:10px;font-size:14px;font-weight:700;color:#0f172a;background:#f1f5f9;text-decoration:none;padding:13px 24px;border-radius:14px;transition:opacity .2s;border:1px solid #e2e8f0">
