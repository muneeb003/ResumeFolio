          ...
          ${d.projects
            ...
            <div class="corp-proj-card" style="background:#fff;border-radius:16px;padding:22px;box-shadow:0 1px 3px rgba(0,0,0,.07),0 4px 16px rgba(0,0,0,.04);border:1px solid #f1f5f9;transition:transform .2s,box-shadow .2s;cursor:default">
              ...
              <div style="display:flex;gap:8px;flex-wrap:wrap">
                ${p.liveUrl ? `<a href="${esc(p.liveUrl)}" target="_blank" rel="noopener" style="font-size:12px;font-weight:600;color:#fff;background:${a};text-decoration:none;padding:6px 14px;border-radius:8px;transition:opacity .2s">Live Demo ↗</a>` : ''}
                ${p.repoUrl ? `<a href="${esc(p.repoUrl)}" target="_blank" rel="noopener" style="font-size:12px;font-weight:600;color:#475569;background:#f1f5f9;text-decoration:none;padding:6px 14px;border-radius:8px;transition:opacity .2s">GitHub ↗</a>` : ''}
              </div>
            </div>`
            )
            .join('')}
    ...
    contact: (d: ResumeData) =>
      `<section id="section-contact" style="margin-bottom:56px">
        ...
        <div style="display:flex;flex-wrap:wrap;gap:14px">
          ...
          ${
            d.contact.github
              ? `<a href="${esc(d.contact.github)}" target="_blank" rel="noopener" style="display:inline-flex;align-items:center;gap:8px;font-size:14px;font-weight:500;color:#0f172a;text-decoration:none;background:#fff;border:1px solid #e2e8f0;padding:10px 18px;border-radius:10px;box-shadow:0 1px 3px rgba(0,0,0,.05);transition:box-shadow .2s">
          ...
          ${
            d.contact.linkedin
              ? `<a href="${esc(d.contact.linkedin)}" target="_blank" rel="noopener" style="display:inline-flex;align-items:center;gap:8px;font-size:14px;font-weight:500;color:#0f172a;text-decoration:none;background:#fff;border:1px solid #e2e8f0;padding:10px 18px;border-radius:10px;box-shadow:0 1px 3px rgba(0,0,0,.05);transition:box-shadow .2s">
...
<script type="application/ld+json">{"@context":"https://schema.org","@type":"Person","name":"${esc(data.name)}","jobTitle":"${esc(data.title)}","description":"${esc(data.bio)}"${data.contact.email ? `,"email":"${esc(data.contact.email)}"` : ''}${data.contact.github ? `,"sameAs":["${esc(data.contact.github)}"${data.contact.linkedin ? `,"${esc(data.contact.linkedin)}"` : ''}]` : ''}}</script>
<style>
...
<aside class="corp-sidebar">
  ...
  <div class="corp-sidebar-contact" style="padding:20px 24px;border-top:1px solid #e2e8f0">
    ...
    ${
      data.contact.github
        ? `<a href="${esc(data.contact.github)}" target="_blank" rel="noopener" style="display:flex;align-items:center;gap:8px;font-size:12px;color:#64748b;text-decoration:none;margin-bottom:10px;transition:color .15s" onmouseover="this.style.color='${a}'" onmouseout="this.style.color='#64748b'">
    ...
    ${
      data.contact.linkedin
        ? `<a href="${esc(data.contact.linkedin)}" target="_blank" rel="noopener" style="display:flex;align-items:center;gap:8px;font-size:12px;color:#64748b;text-decoration:none;transition:color .15s" onmouseover="this.style.color='${a}'" onmouseout="this.style.color='#64748b'">
