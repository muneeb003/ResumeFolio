              ...
              <div class="fl-proj-item" style="display:flex;flex-wrap:wrap;gap:32px;padding:36px 0;border-bottom:1px solid rgba(255,255,255,.07);position:relative;transition:padding-left .2s">
                ...
                <div style="flex:1;min-width:240px">
                  ...
                  <div style="display:flex;gap:10px;flex-wrap:wrap">
                    ${p.liveUrl ? `<a href="${esc(p.liveUrl)}" target="_blank" rel="noopener" style="font-size:13px;font-weight:700;color:#fff;background:${a};text-decoration:none;padding:9px 20px;border-radius:10px;transition:opacity .2s">View Live ↗</a>` : ''}
                    ${p.repoUrl ? `<a href="${esc(p.repoUrl)}" target="_blank" rel="noopener" style="font-size:13px;font-weight:700;color:rgba(255,255,255,.7);background:rgba(255,255,255,.08);text-decoration:none;padding:9px 20px;border-radius:10px;border:1px solid rgba(255,255,255,.12);transition:opacity .2s">Source Code ↗</a>` : ''}
                  </div>
                </div>
              </div>`
              )
      ...
      `<section id="fl-contact" style="background:#111827;padding:100px 0">
        <div style="max-width:700px;margin:0 auto;padding:0 48px;text-align:center">
          ...
          <div style="display:flex;justify-content:center;gap:16px;flex-wrap:wrap;padding-top:32px;border-top:1px solid rgba(255,255,255,.08)">
            ${
              d.contact.github
                ? `<a href="${esc(d.contact.github)}" target="_blank" rel="noopener" style="display:inline-flex;align-items:center;gap:8px;font-size:13px;font-weight:600;color:rgba(255,255,255,.6);text-decoration:none;transition:color .2s" onmouseover="this.style.color='#fff'" onmouseout="this.style.color='rgba(255,255,255,.6)'">
            ...
            ${
              d.contact.linkedin
                ? `<a href="${esc(d.contact.linkedin)}" target="_blank" rel="noopener" style="display:inline-flex;align-items:center;gap:8px;font-size:13px;font-weight:600;color:rgba(255,255,255,.6);text-decoration:none;transition:color .2s" onmouseover="this.style.color='#fff'" onmouseout="this.style.color='rgba(255,255,255,.6)'">
